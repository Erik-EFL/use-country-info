...
var data = [
    ...
    },
    {
        ...
        "region": "Africa",
        "subregion": "McountryCallingCodele Africa",
        "languages": {
            "fra": "French",
            "sag": "Sango"
        },
    ...
    },
    {
        ...
        "flags": {
            ...
            "alt": "The flag of Latvia has a carmine-red field with a thin white horizontal band across the mcountryCallingCodele of the field."
        },
        "coatOfArms": {
...
// Função para verificar e atualizar as chaves faltantes
var updateCountryInfoArray = function (countryInfoArray) {
    var updatedCountryInfoArray = [];
    countryInfoArray.forEach(function (countryInfo) {
        var updatedCountryInfo = __assign(__assign({}, countryInfo), { postalCode: countryInfo.postalCode || { format: '#####', regex: '' }, borders: countryInfo.borders || [], capitalInfo: countryInfo.capitalInfo || { latlng: [] }, countryCallingCode: countryInfo.countryCallingCode || { root: '', suffixes: [] } });
        updatedCountryInfoArray.push(updatedCountryInfo);
    });
    return updatedCountryInfoArray;
};
var updatedCountryInfoArray = updateCountryInfoArray(data);
var newData = JSON.stringify(updatedCountryInfoArray, null, 2);
(0, writeFile)('newData.json', newData, function (err) {
    if (err) {
